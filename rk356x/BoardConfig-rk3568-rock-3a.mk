...
# - - - - - - configure file of RADXA SBC ROCK 3 Model A - - - - - - - - #

# Target arch
export RK_KERNEL_ARCH=arm64
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rk3568-rock-3a
# Uboot image format type: fit(flattened image tree)
export RK_UBOOT_FORMAT_TYPE=fit
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=rk3568-rock-3a_defconfig
# Kernel dts
export RK_KERNEL_DTS=rk3568-rock-3a
# boot image type
...
# Buildroot config
export RK_CFG_BUILDROOT=rk3568-rock-3a
# Recovery config
